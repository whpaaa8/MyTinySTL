 ...
 * @LastEditTime: 2023-10-28 23:32:49
 * @FilePath: \MyTinySTL\Test\algorithm_test.h
...
// algobase test: 
// TEST(name): 通过宏定义 创建名为 对应 的 Testcase 类 并且将其加入 UnitTest 的 测试队列中
// 括号内的是 该TestCase类 的 run 实现
// 与 std 标准函数比较，判断 mystl 的算法是否成功 
TEST(copy_test)
{
